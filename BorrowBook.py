...
class BorrowBook(Toplevel):
    ...
    def setup_ui(self):
        ...
        heading = Label(self.topFrame, text='   Borrow a book', font=("Times New Roman", 22, "bold"), fg='#003f8a',
                        bg='#ADD8E6',)
        heading.place(x=150, y=35)

        # Entries for member name
        self.book_name = StringVar()
        lbl_name = Label(self.bottomFrame, text='Book Name:', font=("Times New Roman", 15, "bold"), fg='#003f8a',
                         bg='#ADD8E6')
        ...
        self.combo_name.place(x=175, y=10)

        # Entries for member surname
        self.member_name = StringVar()
        lbl_surname = Label(self.bottomFrame, text='Member Name:', font=("Times New Roman", 15, "bold"), fg='#003f8a',
                            bg='#ADD8E6')
        lbl_surname.place(x=40, y=70)
        self.combo_member = ttk.Combobox(self.bottomFrame, textvariable=self.member_name)
        self.combo_member['values'] = member_list
        self.combo_member.place(x=175, y=70)
